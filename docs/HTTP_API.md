...
- Secrets are not serialized into dashboard, status, traffic, account, broadcast or metrics responses.
...
Fields are additive within the 0.29 line. Consumers should ignore unknown JSON keys. Existing field removal or semantic changes require a changelog entry and migration note.
